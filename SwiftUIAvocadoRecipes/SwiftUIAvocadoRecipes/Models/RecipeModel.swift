...
let recipesData: [RecipeModel] = [
    ...
    RecipeModel(
      ...
      image: .avocadoCrunchyCelerySalsa,
      rating: 5,
      serves: 1,
      preparation: 10,
      cooking: 5,
